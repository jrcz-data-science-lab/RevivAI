...
const HELP_MESSAGES: Record<LLMProvider, JSX.Element | null> = {
	...
	openrouter: (
		<span>
			...
			<a
				href="https://openrouter.ai/docs/faq#how-do-i-get-started-with-openrouter"
	...
	custom: <span>You can use any LLM provider that supports the OpenAI API. Just enter the API URL and API key.</span>,
	revivai: null,
};
